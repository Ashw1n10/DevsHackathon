...
function MatchProfilePopup({ onClose }) {
  ...
  return (
    <div className={`${styles.popupContainer} ${isClosing ? styles.closing : ''}`}>
      <button className={styles.closeBtn} onClick={closing}>X</button>
      ...
      <div className={styles.btns}>
        <div>
          <button className={styles.matchBtn} onClick={closing}>Match</button>
        </div>
        <div>
          <button className={styles.rejectBtn} onClick={closing}>Reject</button>
        </div>
      </div>
    </div>
  );
